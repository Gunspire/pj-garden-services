...
export function HeroSection() {
  const heroImages = SITE.imagePool;
          ...
          <div className="lg:col-span-8">
            <div className="inline-flex items-center gap-2 bg-blue-600/20 border border-blue-500/30 rounded-full px-4 py-1.5 mb-6 backdrop-blur-sm">
              ...
              <span className="text-emerald-50 text-sm font-medium">
                Trusted gardeners • Tidy work • Clear quotes
              </span>
            </div>

            <h1 className="text-3xl lg:text-5xl font-bold text-white leading-tight mb-6">
              Gardening & landscaping in <span className="text-emerald-300">London</span>. Fast quotes, tidy
              finishes, reliable service.
            </h1>

            <p className="text-lg text-slate-300 mb-8 leading-relaxed max-w-xl">
              From lawn care and hedge trimming to garden clearances and fencing,{" "}
              <span className="font-semibold text-white">{SITE.companyName}</span> helps you keep your
              outdoor space looking its best—without the hassle.
            </p>
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-slate-700/50">
              <div className="flex flex-col max-w-[200px]">
                <p className="text-slate-200 italic text-sm mb-2">
                  {"Best gardener we’ve used. Quick, tidy and professional."}
                </p>
