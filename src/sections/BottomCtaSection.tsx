...
export function BottomCtaSection() {
  const bg = SITE.imagePool[4] ?? SITE.imagePool[0];
  ...
  return (
    <section className="relative overflow-hidden py-16 lg:py-20">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-950/85 via-emerald-900/60 to-slate-900/40" />
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-5 text-white">
            ...
            <p className="text-blue-100/90 mt-4 text-lg leading-relaxed">
              Tell us what you need and we’ll come back with a clear, itemised quote. For urgent
              storm mess or make-safe work, call us.
            </p>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100/90 text-sm mt-1">{SITE.phoneDisplay}</p>
                    <p className="text-blue-200 text-xs mt-1">Ask about urgent call-outs</p>
                  </div>
                </div>
              </a>

              <a
                href={`https://wa.me/${SITE.whatsappNumberE164}?text=${encodeURIComponent(
                  SITE.whatsappPrefillText
                )}`}
                target="_blank"
                rel="noreferrer"
                className="group rounded-2xl bg-white/10 border border-white/15 backdrop-blur px-5 py-4 hover:bg-white/15 transition"
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100/90 text-sm mt-1">{SITE.email}</p>
            ...
            <div className="mt-8 flex items-center gap-3 text-blue-100/90">
              ...
              <span className="text-sm">Fully insured • Clear, upfront pricing • Tidy finish</span>
            </div>
          </div>
