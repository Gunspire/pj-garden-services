    ...
    <section id="reviews" className="py-20 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              text: "PJ Garden Services were fantastic from start to finish. Clear quote, turned up on time, and the garden looks brilliant. Left everything spotless.",
              author: "Sarah Jenkins",
              location: "Richmond",
              date: "2 weeks ago",
            },
            {
              text: "Storm brought down branches and made a mess of the patio. They came out quickly, made it safe, and cleared everything away. Lifesavers.",
              author: "Mike Thompson",
              location: "Wimbledon",
              date: "1 month ago",
            },
            {
              text: "Competitive price for fencing and a full tidy-up. Polite, hardworking and respectful of our property. Highly recommend.",
              author: "David Clarke",
              location: "Clapham",
              date: "2 months ago",
            },
