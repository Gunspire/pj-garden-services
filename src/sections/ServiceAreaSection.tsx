    ...
    <section className="bg-white py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          <div>
            <SectionHeading subtitle="Service Area">{SITE.serviceAreaPrimary}</SectionHeading>

            <p className="text-slate-600 text-lg leading-relaxed mb-6">
              We’re based in London and typically cover{" "}
              <span className="font-semibold text-slate-900">up to ~50 miles</span> for lawn care, hedge
              trimming, garden clearance, fencing and emergency call-outs.
            </p>
