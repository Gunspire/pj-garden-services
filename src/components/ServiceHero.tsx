        ...
        {backgroundImageSrc ? (
          <>
            <img
              ...
              decoding="async"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-950/85 via-emerald-900/60 to-slate-900/35" />
            <div className="absolute inset-0 bg-slate-950/15" />
          </>
        ) : (
          <>
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-950 via-emerald-900 to-slate-900" />
            <div className="absolute inset-0 opacity-60 bg-[radial-gradient(circle_at_20%_30%,rgba(16,185,129,0.35),transparent_55%),radial-gradient(circle_at_70%_10%,rgba(34,197,94,0.25),transparent_55%),radial-gradient(circle_at_80%_80%,rgba(255,255,255,0.08),transparent_55%)]" />
          </>
        )}
      </div>
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-8">
            <div className="inline-flex items-center gap-2 bg-blue-600/20 border border-blue-300/20 rounded-full px-4 py-1.5 backdrop-blur-sm">
              ...
              <span className="text-emerald-50 text-sm font-semibold">{serviceName}</span>
            </div>
