        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-8 items-start">
          <div className="lg:col-span-8">
            ...
            <p className="mt-5 text-lg text-blue-50/90 font-medium leading-relaxed max-w-2xl">
              Browse recent gardening and landscaping work—from lawn care to full garden refreshes. If
              you like what you see, request a quote and we’ll get back quickly with clear next steps.
            </p>
